        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    JornayaLeadId = table.Column<string>(type: "TEXT", nullable: true),
                    JornayaVerified = table.Column<bool>(type: "INTEGER", nullable: false),
                    JornayaVerifiedAt = table.Column<DateTime>(type: "TEXT", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "TEXT", nullable: false),
                    CidrOrIp = table.Column<string>(type: "TEXT", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_IpAllowlist", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Teams_Agencies_AgencyId",
                        column: x => x.AgencyId,
                        principalTable: "Agencies",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ValidatorUserId = table.Column<Guid>(type: "TEXT", nullable: true),
                    ...
                    FundedAt = table.Column<DateTime>(type: "TEXT", nullable: true),
                    IsInternalSale = table.Column<bool>(type: "INTEGER", nullable: false),
                    InternalSaleReason = table.Column<string>(type: "TEXT", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "TEXT", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "TEXT", nullable: true),
                    CreatedBy = table.Column<string>(type: "TEXT", nullable: true),
                    UpdatedBy = table.Column<string>(type: "TEXT", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ScheduledCallbacks", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ScheduledCallbacks_Leads_LeadId",
                        column: x => x.LeadId,
                        principalTable: "Leads",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Leads_AgencyId_PhoneNumber",
                table: "Leads",
                columns: new[] { "AgencyId", "PhoneNumber" });

            migrationBuilder.CreateIndex(
                name: "IX_Leads_AgencyId_Stage",
                table: "Leads",
                columns: new[] { "AgencyId", "Stage" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Sales_AgencyId_SoldAt",
                table: "Sales",
                columns: new[] { "AgencyId", "SoldAt" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ScheduledCallbacks_LeadId",
                table: "ScheduledCallbacks",
                column: "LeadId");

            migrationBuilder.CreateIndex(
                name: "IX_Teams_AgencyId_Name",
                table: "Teams",
                columns: new[] { "AgencyId", "Name" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_TwoFactorPendingTokens_Token",
